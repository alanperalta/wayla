<?php
    ...
    if(!$do_login['error']){
        ...
        $getDataResult = ItsGetData($do_login['usersession'], '_TUR_CONTRATOS', '1', "ID like 'CES%".str_pad(str_replace('CESE','',$contrato), 12, '0', STR_PAD_LEFT)."' AND ESTADO = 'A' AND CLAVE = '".$clave."'");
